...
This module belongs to `graphwiki_kb.services.concept_service` and keeps related behavior
...
from graphwiki_kb.services.markdown_document import parse_document
