...
The agent control plane is architecture, not just CLI sugar: it adds an optional
OpenAI Agents SDK boundary while preserving the existing command/service split
and local approval gates.
