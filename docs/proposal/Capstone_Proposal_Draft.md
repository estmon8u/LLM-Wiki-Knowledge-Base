...
| Project Update 3: graph controller and maintenance validation | May 13 to May 26 | Route default ask behavior through GraphRAG, evaluate local/global/basic/DRIFT modes on the real corpus, run stale-page and graph freshness checks, and measure refresh behavior | Update 3 demonstrates GraphRAG-aware default asking plus synthesis and maintenance validation |
