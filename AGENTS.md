...
- **GraphRAG lock files are runtime state**: `graph/graphrag/.workspace.state.lock` is ignored and must not be staged. It belongs to local GraphRAG workspace locking only.
